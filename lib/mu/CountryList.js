 ...
 * Country list
 */
export const CountryList = React.forwardRef(({ InputLabelProps, label, loadItems, name, renderInput, sort, ...rest }, ref) => {
    // Cache key
    ...
    const renderInputLocal = renderInput || ((params) => {
        return React.createElement(TextField, Object.assign({}, mergeProperties(params)));
    });
    // Return
